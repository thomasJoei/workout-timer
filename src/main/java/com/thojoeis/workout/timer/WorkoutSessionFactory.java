...
public class WorkoutSessionFactory {
    ...
    private static final String restLabel = "Rest";
    private static final String restRoundLabel = "Round Rest";
        ...
        List<Round> rounds = IntStream
                ...
                .mapToObj(roundIndex -> {
                    List<Interval> roundIntervals = exercises.stream()
                            .flatMap(exercise -> Stream.of(exercise, createRestInterval(restTime, restLabel)))
